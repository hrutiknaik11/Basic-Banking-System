...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#fff; opacity:1;"> 
            ...
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:green;font-family: 'Lucida Handwriting';font-size:2em;">
                &nbsp;Your Bank
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:green;font-weight:1em;font-size: 20px;font-family: 'Lucida Handwriting';">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:green;font-weight:1em;font-size: 20px;font-family: 'Lucida Handwriting';">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:green;font-weight:1em;font-size: 20px;font-family: 'Lucida Handwriting';">
                            <div style="padding-left:20px;" >
