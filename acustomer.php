...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        ...
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:transparent; background-color:#fff; opacity:1;"> 
            <img  height="90"src="./images/icon1.jpg">
            &nbsp;
            <div class="navbar-brand font-weight-bold " id="title" data-anijs="if: mouseover, do: slideInUp animated" style="color:black;font-family: 'Lucida Handwriting';font-size:2em;">
                &nbsp;Your Bank
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:black;font-weight:1em;font-size: 20px;font-family: 'Lucida Handwriting';">
                            <div style="padding-right:0px;" >
                                
                            </div>
                            <span style="padding-right:20px;font-family: 'Lucida Handwriting';" >&nbsp;&nbsp;Home</span>
                        </a> 
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="color:black;font-weight:1em;font-size: 20px;font-family: 'Lucida Handwriting';">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="color:black;font-weight:1em;font-size: 20px;font-family: 'Lucida Handwriting';">
                            <div style="padding-left:20px;" >
...
<div class="row">
    ...
    <img  height="50" src="./images/arrow3.png" alt="" style="display:inline;">&nbsp;
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:green;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:green;font-size:1.8em;line-height:1em;font-family: 'Lucida Handwriting';display:inline;margin:10px 5px 0px 5px;padding-top:1%">Money Transfer</span>
                    </div><br><br>
                    <b style="font-size:1.2em;">Sender</b> : <span style="font-size:1.2em;font-family: 'Lucida Handwriting';"><input id="myinput" name="sender" disabled type="text" style="width:40%;border:none;" value='<?php echo "$user";?>'></input></span>
                ...
                <br><br><br>
                        <b style="font-size:1.2em;">Amount &#8377;:</b>
...
<div class="footer">
        <a href="#">© 2020 Your Bank</a><br></div>
</body>
